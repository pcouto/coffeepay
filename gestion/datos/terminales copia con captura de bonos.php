...
function update_terminal($data)
  {
      ...
      $str = "INSERT INTO journal (Fecha, Terminal,Establecimiento,Operacion, Descripcion,Importe,Notes) VALUES ('".date('Y-m-d H:i:s')."','$term', '$est','Bonos Añadidos $data -  $bon - $oldbonos','$bon Bonos',0,'Usuario : $username')";
  ...
  <link rel="stylesheet" href="./lib/js/themes/custom/jquery-ui.custom.css"></link>
    ...
    <!-- Bootstrap CSS -->
      ...
      <script type="text/javascript">
        ...
        { // captura el numero de terminal seleccionada
           // document.cookie = "ckterminal=" + $data;
	...
	<body>
      ...
      function do_onselect(id)
      {
        ...
        s.innerHTML = "Seleccionado Id : "+ id;
        const f = document.getElementById("MRterminal");
            const g = document.getElementById("MCterminal");
            const h = document.getElementById("MIterminal");
            f.innerHTML = $data;
