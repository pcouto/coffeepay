...
$f["column"] = "Operacion";
$f["op"] = "=";
$f["value"] = "Solicitado Reset";
$f["css"] = "'background-color': '#94a69e','color':'white' ,'font-weight': 'bold'"; // css class name
$f_conditions[] = $f;

$f = array();
$f["column"] = "Operacion";
$f["op"] = "=";
$f["value"] = "Solicitada Cancelación";
$f["css"] = "'background-color': '#881744','color':'white' ,'font-weight': 'bold'"; // css class name
$f_conditions[] = $f;

$f = array();
$f["column"] = "Operacion";
$f["op"] = "=";
$f["value"] = "Solicitado Cierre";
...
function pre_render($data)
{
  ...
  $swhere = "WHERE Operacion LIKE 'Cierre%'"  . $_SESSION["jqgrid_list1_filter"];
...
function select_client($data)
{
  ...
  //$str = "UPDATE clients SET name='MEU NOME'	WHERE client_id = {$data["client_id"]}";
...
<head>
  ...
  <link rel="stylesheet" type="text/css" media="screen" href="https://cdn.rawgit.com/tamble/jquery-ui-daterangepicker/0.5.0/jquery.comiseo.daterangepicker.css">
  </link>
  ...
  <script>
    ...
    jQuery("#search_date").click(function() {
      ...
      jQuery.extend(grid[0].p.postData, {
...
*************************************************************************/
    ...
    function grid_onload() {
      ...
      grid.jqGrid('footerData', 'set', {
        Notes: 'Ventas : ' + Intl.NumberFormat('eu-EU', {
          style: 'currency',
          currency: 'EUR'
        }).format(sum_Recargas) + ' / Cierres : ' + Intl.NumberFormat('eu-EU', {
          style: 'currency',
          currency: 'EUR'
        }).format(sum_Cierres)
      }, false);
...
<body>
  ...
  <header id="pageHeader">
    <p>
    <H6>Movimiento de Terminales.<H6>
        </p>
  </header>
  <logo id="pageLogo">
    CAFE DUETAZZE
