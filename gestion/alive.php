  ...
  // Es este
      ...
      // Obtenemos las variable Posteadas.
        ...
        // Tipo de Terminal -> 0 =  por dosis, las dosis A y B valen lo mismo, 1 = Por importe, las dosis A y B pueden tener precios distintos.
        $CreditType=0;
      ...
      if (mysqli_affected_rows($conexion)==0) {
        ...
        $preciopordosisb = $row['PrecioPorDosisB'];
        $status = $row ['Estado'];
        $bonos = $row ['Bonos'];
        $command = $row['Command'];
        ...
        $RegTotalDosisB = $row['TotalDosisB'];
          ...
          echo '"preciopordosisb" : "'.$preciopordosisb.'",';
          echo '"status" : "'.$status.'",';
          echo '"bonos" : "'.$bonos.'",';
