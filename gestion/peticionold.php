      ...
      ***********************************************************************************************************************/
      ...
      $StrXML =  "<?xml version='1.0' encoding='UTF-8'?>
        <REQUEST type = 'RESP' mode='' >
          ...
          <DOSISPOREURO>$DosisPorEuro</DOSISPOREURO>
      ...
      if ($Operacion=="Venta"){
        $Descripcion = $Descripcion + "a : "+ $DosisPorEuro + "Por Dosis";
      }
      ...
      $Sql = "update datos set numoperations = numoperations + 1, lastopdate = '".date('Y-m-d H:i:s')."' where terminal = '$Terminal'";
